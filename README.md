# online_sport_platform
a django web app based


README.md for Sportex Project

Overview

Sportex is a professional, production-ready online fitness coaching and sports management platform. It facilitates seamless interaction between coaches and clients, manages subscription plans, automates workout program creation, generates secure program PDFs, and offers dynamic user assessment tools.
...
Clone the Repository:git clone https://github.com/yourusername/sportex.git



Environment Variables: Create a .env file from .env.example and populate your credentials.
...
Admin: Create an account via python manage.py createsuperuser.



Task Queue: Start the Celery worker: celery -A config worker --loglevel=info.



Server: Run the application with python manage.py runserver.
